...
<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title"><?php echo TEXT::get("link_to_live_data"); ?></h3>
	</div>
	<div class="panel-body bg-lightgrey">
		<form method="post" action="<?php echo Config::get('URL'); ?>batch/feed/">
			<label for="feed"><?php echo TEXT::get("feed"); ?></label>
			<div class="input-group">
				<div class="input-group-btn">
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">CSV <span class="caret"></span></button>
				...
				<input type="text" class="form-control" name="feed" id="feed" placeholder="http://" value="<? echo $filename; ?>">
			</div>
			<div class="checkbox">
				<label>
					<input type="checkbox" name="firstline" value="ignore"
					<?php if($firstline=="ignore") {
						echo "checked";
					} ?>
					> <?php echo TEXT::get("ignore_first_line"); ?>
				</label>
			</div>
